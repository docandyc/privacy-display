...
- Upper green branch: simple eye icon, label "Human visual system", a subtle temporal accumulation symbol across all subframes, label "Temporal integration", ending in a fully readable display thumbnail containing "PRIVATE DATA" and label "Readable reconstruction". Do not state a fixed integration time.
