...
def main():
    ...
    metadata = {
        ...
        "source_visual_inventory": {
            ...
            "regions": [
                ...
                },
                {
                    ...
                    "required_labels": [
                        "Human eye", "Temporal integration", "Readable", "PRIVATE DATA",
                    ],
                    "required_formulas": [],
                ...
                },
                {
                    ...
                    "required_crop_types": ["output", "arrow_dense", "small_text"],
                    "required_labels": [
                        "Camera", "Short-exposure sampling", "Unreadable fragment", "OCR",
                    ],
                    "required_formulas": [],
        ...
        "arrow_plan": [
            ...
            arrow_plan("A009", "camera_output", "The selected second subframe feeds the camera.",
                       ...
                       [970, 540, 1030, 730], ["Short-exposure sampling"], ["vertical selection lane"]),
            arrow_plan("A010", "camera_output", "The camera outputs one unreadable fragment.",
                       ...
                       "left_to_right", "straight_horizontal", "solid", "end", "data_flow",
                       [1040, 720, 1190, 770], ["Short-exposure sampling"], ["lower camera lane"]),
    ...
    nodes = [
        ...
        label("camera_label", 905, 800, 150, 42, "Camera", "camera_region",
              size=7.0, color=red, weight="bold"),
        label("sampling_label", 1040, 615, 190, 42, "Short-exposure", "camera_region",
