...
- Visible semantic nodes: 70
- Edges: 15
- Regions: 4
- Region-covered visible nodes: 69/70
...
- `subframe_core`: ok, source=[760, 350, 1500, 650], target=[750, 370, 1510, 690]
- `human_output`: ok, source=[900, 60, 1510, 350], target=[830, 80, 1510, 440]
- `camera_output`: ok, source=[870, 610, 1536, 940], target=[850, 650, 1520, 1000]
...
- `human_region`: 12 visible nodes, density=9.44/sqin, center=(2.67, 0.59) `ok`, source_ar=2.10
- `subframe_region`: 15 visible nodes, density=11.88/sqin, center=(2.57, 1.21) `ok`, source_ar=2.47
- `camera_region`: 12 visible nodes, density=9.86/sqin, center=(2.70, 1.88) `ok`, source_ar=2.02
...
- `text_block`: 6.5-7.8 pt across 22 nodes

## Text Fit Risks
- `panel_a_title` 1.46x0.11 in estimated vs 1.44x0.04 in
- `authorized_line1` 0.46x0.11 in estimated vs 0.46x0.04 in
...
- `phone_line1` 0.49x0.11 in estimated vs 0.49x0.04 in
- `phone_line2` 0.30x0.11 in estimated vs 0.49x0.04 in
...
- `integration_line1` 0.37x0.11 in estimated vs 0.36x0.00 in
- 7 additional text-fit risks suppressed.
...
- WARN: Text in node `panel_a_title` may not fit (1.46x0.11 in estimated vs 1.44x0.04 in available). Wrap text, enlarge the node, or assign a smaller role font before rendering.
- WARN: Text in node `authorized_line1` may not fit (0.46x0.11 in estimated vs 0.46x0.04 in available). Wrap text, enlarge the node, or assign a smaller role font before rendering.
...
- WARN: Text in node `phone_line1` may not fit (0.49x0.11 in estimated vs 0.49x0.04 in available). Wrap text, enlarge the node, or assign a smaller role font before rendering.
- WARN: Text in node `phone_line2` may not fit (0.30x0.11 in estimated vs 0.49x0.04 in available). Wrap text, enlarge the node, or assign a smaller role font before rendering.
...
- WARN: Edge `frame1_to_eye` directly connects components across module boundary (subframe_region -> human_region). For exact replicas, route through `boundary_port`/`boundary_arrow` unless the source visibly connects component-to-component.
- WARN: Edge `frame2_to_eye` directly connects components across module boundary (subframe_region -> human_region). For exact replicas, route through `boundary_port`/`boundary_arrow` unless the source visibly connects component-to-component.
- WARN: Edge `frame3_to_eye` directly connects components across module boundary (subframe_region -> human_region). For exact replicas, route through `boundary_port`/`boundary_arrow` unless the source visibly connects component-to-component.
- WARN: Edge `frame4_to_eye` directly connects components across module boundary (subframe_region -> human_region). For exact replicas, route through `boundary_port`/`boundary_arrow` unless the source visibly connects component-to-component.
- WARN: Edge `selected_to_camera` directly connects components across module boundary (subframe_region -> camera_region). For exact replicas, route through `boundary_port`/`boundary_arrow` unless the source visibly connects component-to-component.
