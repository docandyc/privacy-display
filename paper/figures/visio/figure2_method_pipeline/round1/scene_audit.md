...
### `stage_3_camera`
- Frame: `rectangle` `solid`
- Children (11): `camera_title`, `camera_icon`, `camera_frame_1`, `camera_frame_2`, `camera_frame_3`, `camera_frame_4`, `sampled_fragment`, `ocr_failure`, `camera_sampling_label`, `camera_action_label`, `unreadable_label`
...
- [ ] `stage_1_title` is a long text block without role/semantic_role; classify it as title/caption/header/formula/annotation before visual polishing.
...
- [ ] `mask_label` text is likely to shrink/wrap (1.09x0.26 estimated vs 0.60x0.21); use `math_text`, caption runs, or source-sized text box.
...
- [ ] `optional_label` text is likely to shrink/wrap (0.91x0.25 estimated vs 0.65x0.18); use `math_text`, caption runs, or source-sized text box.
...
- [ ] `noise_title` text is likely to shrink/wrap (0.91x0.26 estimated vs 0.58x0.20); use `math_text`, caption runs, or source-sized text box.
...
- [ ] `integration_label` is a long text block without role/semantic_role; classify it as title/caption/header/formula/annotation before visual polishing.
...
- [ ] `ocr_failure` text is likely to shrink/wrap (0.23x0.33 estimated vs 0.15x0.21); use `math_text`, caption runs, or source-sized text box.
- [ ] `camera_action_label` text is likely to shrink/wrap (0.77x0.25 estimated vs 0.94x0.18); use `math_text`, caption runs, or source-sized text box.
- [ ] `unreadable_label` text is likely to shrink/wrap (0.54x0.25 estimated vs 0.58x0.18); use `math_text`, caption runs, or source-sized text box.
- [ ] `sampling_window` lacks source_bbox_px/source_aspect_ratio; visual LLM cannot tell whether region proportion or child coordinates caused mismatch.
