...
Attack-oriented evaluation expands this result: a temporal-mean attack averaging 150 short-exposure frames (nominally 2.5\,s at 60\,fps) and vision-language model (VLM) probes recovered considerable large-font text (\S\ref{sec:vlm}), showing where recovery rises beyond the primary conventional-OCR setting.
...
\S\ref{sec:related} reviews prior work, \S\ref{sec:threat} defines the threat model, and \S\ref{sec:method} presents the design. \S\ref{sec:evaluation} reports OCR evidence, VLM probes, the usability study, detection/tracking stress tests, and simulation diagnostics. \S\S\ref{sec:discussion} and~\ref{sec:conclusion} discuss the evidence hierarchy.
