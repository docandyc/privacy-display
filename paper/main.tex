...
\begin{table}[!t]
\caption{Within-subject typing outcomes for control and readability-priority masking ($N=56$).}
...
\begin{table}[!t]
\caption{Subjective ratings across six display conditions ($N=56$; mean $\pm$ SD).}
