...
RESULT_FILES = [
    ...
    *REAL_CAPTURE_POSITION_RESULT_FILES,
    ...
    "experiments/results/anti_ocr_profile_ablation.json",
    "experiments/results/paper_ocr_clustered_stats.json",
    "experiments/results/paper_ocr_clustered_stats.md",
    "experiments/results/sensitive_field_recovery.json",
    "experiments/results/sensitive_field_recovery.md",
    "experiments/results/real_capture_design_audit.json",
    "experiments/results/real_capture_design_audit.md",
    "experiments/results/vlm_missing_response_bounds.json",
    "experiments/results/vlm_missing_response_bounds.md",
    "experiments/results/real_capture_preprocessing_attack_tesseract.json",
    "experiments/results/real_capture_preprocessing_attack_tesseract.md",
    "experiments/results/real_capture_preprocessing_attack_easyocr.json",
    "experiments/results/real_capture_preprocessing_attack_easyocr.md",
    "experiments/results/real_capture_preprocessing_attack_surya.json",
    "experiments/results/real_capture_preprocessing_attack_surya.md",
    "experiments/results/real_capture_preprocessing_attack_three_engine.json",
    "experiments/results/real_capture_preprocessing_attack_three_engine.md",
...
SOURCE_FILES = [
    ...
    "docs/windows_easyocr_surya_preprocessing.md",
    ".env.example",
    "requirements.txt",
    ...
    "experiments/anti_ocr_profile_ablation.py",
    ...
    "experiments/paper_figures/fig_s5_real_engine_ocr.py",
...
REPRODUCTION_COMMANDS = [
    ...
    {
        "name": "anti_ocr_profile_ablation",
        "command": "python experiments/anti_ocr_profile_ablation.py --max-samples 16",
        "purpose": "Measure profile-level integration recovery and digital reconstruction quality.",
        "expected": "experiments/results/anti_ocr_profile_ablation.json",
    },
    {
    ...
    {
        "name": "paper_ocr_cluster_analysis",
        "command": "python experiments/analyze_paper_ocr_clusters.py",
        "purpose": "Regenerate the matched common-setting and capture-cluster OCR summaries used by the manuscript.",
        "expected": "experiments/results/paper_ocr_clustered_stats.json and paper_ocr_clustered_stats.md",
        "requires_data": ["experiments/results/real_capture_ocr.json"],
    },
    {
        "name": "sensitive_field_recovery",
        "command": "python experiments/analyze_sensitive_field_recovery.py",
        "purpose": "Score explicit high-value-field recovery from the versioned annotation manifest.",
        "expected": "experiments/results/sensitive_field_recovery.json and sensitive_field_recovery.md",
        "requires_data": [
            "experiments/results/real_capture_ocr.json",
            "experiments/config/real_capture_sensitive_fields.json",
        ],
    ...
    {
        "name": "real_capture_design_audit",
        "command": "python experiments/audit_real_capture_design.py",
        "purpose": "Audit acquisition order, matched geometries, corpus composition, and known/unknown capture controls.",
        "expected": "experiments/results/real_capture_design_audit.json and real_capture_design_audit.md",
        "requires_data": ["experiments/results/real_capture_ocr.json"],
    },
    {
        "name": "vlm_missing_response_bounds",
        "command": "python experiments/analyze_vlm_missing_response_bounds.py",
        "purpose": "Regenerate lower/upper outcome bounds for VLM cells with failed calls.",
        "expected": "experiments/results/vlm_missing_response_bounds.json and vlm_missing_response_bounds.md",
        "requires_data": ["experiments/results/real_capture_vlm.json"],
    },
    {
        "name": "real_capture_preprocessing_tesseract",
        "command": "python experiments/real_capture_preprocessing_attack.py --engines tesseract --json-out experiments/results/real_capture_preprocessing_attack_tesseract.json --md-out experiments/results/real_capture_preprocessing_attack_tesseract.md",
        "purpose": "Regenerate the fixed-grid Tesseract preprocessing-oracle report from its resumable cell matrix.",
        "expected": "experiments/results/real_capture_preprocessing_attack_tesseract.json and real_capture_preprocessing_attack_tesseract.md",
        "requires_data": [
            "experiments/results/real_capture_ocr.json",
            "experiments/results/real_capture_preprocessing_rows/matrix.jsonl",
            "referenced capture image files when matrix cells are missing",
        ],
    },
    {
        "name": "real_capture_preprocessing_easyocr",
        "command": ".venv-surya/Scripts/python.exe experiments/real_capture_preprocessing_attack.py --engines easyocr --checkpoint experiments/results/real_capture_preprocessing_rows/matrix.jsonl --json-out experiments/results/real_capture_preprocessing_attack_easyocr.json --md-out experiments/results/real_capture_preprocessing_attack_easyocr.md --workers 1",
        "purpose": "Regenerate the fixed-grid EasyOCR preprocessing-oracle report from its resumable cell matrix.",
        "expected": "experiments/results/real_capture_preprocessing_attack_easyocr.json and real_capture_preprocessing_attack_easyocr.md",
        "requires_data": [
            "experiments/results/real_capture_ocr.json",
            "experiments/results/real_capture_preprocessing_rows/matrix.jsonl",
            "referenced capture image files when matrix cells are missing",
    ...
    {
        "name": "real_capture_preprocessing_surya",
        "command": ".venv-surya/Scripts/python.exe experiments/real_capture_preprocessing_attack.py --engines surya --checkpoint experiments/results/real_capture_preprocessing_rows/matrix.jsonl --json-out experiments/results/real_capture_preprocessing_attack_surya.json --md-out experiments/results/real_capture_preprocessing_attack_surya.md --workers 1",
        "purpose": "Regenerate the fixed-grid Surya preprocessing-oracle report from its resumable cell matrix.",
        "expected": "experiments/results/real_capture_preprocessing_attack_surya.json and real_capture_preprocessing_attack_surya.md",
        "requires_data": [
            "experiments/results/real_capture_ocr.json",
            "experiments/results/real_capture_preprocessing_rows/matrix.jsonl",
            "referenced capture image files when matrix cells are missing",
